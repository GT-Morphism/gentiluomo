...
<aside data-component="collapsible-callout" aria-labelledby={labelId}>
  <DonDetails {open}>
    {#snippet summary()}
      <div class="prose" data-collapsible-callout-child="header">
        <div id={labelId} data-collapsible-callout-child="label">
          <IconInfo aria-hidden="true" />
          <span>Info</span>
        </div>

        {#if tldr}
          <span data-collapsible-callout-child="tldr">{tldr}</span>
        {/if}
    ...
    <div class="flow prose" data-collapsible-callout-child="body">
      {@render body()}
    </div>
  </DonDetails>
</aside>
...
<style>
  @layer components {
    [data-component="collapsible-callout"] {
    ...
    [data-collapsible-callout-child="header"] {
      position: relative;
      ...
      &:has([data-collapsible-callout-child="tldr"]) {
        display: grid;
        grid-template-columns: auto 1fr auto;
      }

      &:not(:has([data-collapsible-callout-child="tldr"])) {
        display: flex;
    ...
    [data-collapsible-callout-child="label"] {
      display: flex;
      align-items: center;
    ...
    [data-collapsible-callout-child="body"] {
      padding-inline: var(--_spacing-inline);
